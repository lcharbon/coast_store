...
class ShippingProviderSelector extends Component {
	...
	toLocalePrice(price) {
		return (price * currencies[locale.currency].conversionCAD).toFixed(2);
	}
	...
	renderFastestSelection() {
		...
		return (
			<ShippingProviderSelection
				...
				price={ $TInject(27, [this.toLocalePrice(this.props.fulfilment.rates.fastest.amount)])}
	...
	renderLeastCostlySelection() {
		...
		return (
			<ShippingProviderSelection
				...
				dataKey={"leastCostly"}
				selectedKey={ this.props.selectedKey }
				price={ $TInject(27, [this.toLocalePrice(this.props.fulfilment.rates.leastCostly.amount)])}
	...
	renderBestValueSelection() {
		...
		return (
			<ShippingProviderSelection
				...
				dataKey={"bestValue"}
				selectedKey={ this.props.selectedKey }
				price={ $TInject(27, [this.toLocalePrice(this.props.fulfilment.rates.bestValue.amount)])}
